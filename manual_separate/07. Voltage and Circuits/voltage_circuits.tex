...
\begin{enumerate}
	...
	\item Brainstorm with your lab partner the variety of ways the light bulb may be made to glow. Draw or otherwise show what to do to light up the bulb. Also, discuss and draw unsuccessful methods. Label your diagrams.
\answerspace{3.0in} 
...
\begin{enumerate}
	...
	\item	Tare (``zero'') the voltage sensor. Connect the terminals to each other with a wire in order to create a short circuit for taring the sensor. Choose Zero voltage sensor from the Sensors menu. The potential reading $V$ should be close to zero
...
How can you determine whether current is present in a wire?
\answerspace{2.0in}

\textbf{Part II: Lighting a  bulb}

Draw a circuit diagram for the wire, light bulb, and battery.
\answerspace{2.0in}
