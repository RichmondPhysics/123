...
\begin{enumerate}
	...
	\item When the temperature drops to about 6.0$^\circ$C greater than room temperature, click or tap Collect to start data collection. Collect data for around 10 min.
