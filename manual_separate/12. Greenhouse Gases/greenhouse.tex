...
\begin{enumerate}
	...
	\item Connect the fast-responses temperature sensor and the CO$_{2}$ sensor to the data collection system. 
	 \item Display Temperature and CO$_{2}$ concentration on the $y$-axis of a graph with Time on the $x$-axis. 
	...
	\begin{enumerate}[(a)]
		...
		\item Place the lid on the chamber. Add one solid stopper (size 5 or 5 1/2 will work) to one of the holes on the side of the chamber, and the CO$_{2}$ sensor on the other. If the stoppers are not solid, cover them with heavy-duty tape to ensure a good seal. 
	\end{enumerate}
...
\end{center}
	...
	\item Repeat the data collection for CO$_{2}$ (dry ice). Make sure your CO$_{2}$ concentration is saturated before starting the experiment. Write the method of procedure you will use to collect data for CO$_{2}$.\answerspace{1.5in} 
...
\begin{center}
\begin{tabular}{ | M{2.5cm} | M{2cm} | M{2cm} | M{2cm} |M{2cm} | M{2cm} | }
 \hline
 \multicolumn{6}{|c|}{Table 1: Temperature data} \\ \hline
 Chamber & Initial Temp. \newline ($^\circ$C) & Maximum Temp. ($^\circ$C) & Increase in Temp. ($^\circ$C) & Final Temp. ($^\circ$C) & Change in Temp. ($^\circ$C) \\ \hline
 Control (air) & & & & & \\[15pt] \hline
 Experimental (difluoreothane) & & & & & \\[15pt] \hline
 Experimental (CO$_{2}$) & & & & & \\[15pt] \hline
\end{tabular}
\end{center}
	...
	\answerspace{1.5in}
	\item Add here a picture of you data collection.
	\answerspace{2.0in}
\end{enumerate}
