...
In the United States in 2021, a majority of the energy consumed was generated using non-renewable resources.\footnote{US Energy Information Administration, September 2022, \textit{Monthly Energy Review}, Table 1.3: \url{www.eia.gov/totalenergy/data/browser/index.php?tbl=T01.03\#/?f=A}} The data in Figure \ref{US_energy_2021} represent energy consumed for the transportation, residential, commercial, and industrial sectors, as well as energy used for the production of electricity. Petroleum and natural gas were used to produce more than $60\%$ of the energy consumed.

\begin{center}
\begin{figure}[h]
{\par\centering \includegraphics{US_energy_2021.png} \par}
\caption{United States energy sources for all sectors, 2021} \label{US_energy_2021}
\end{figure}
\end{center}

If you examine only the energy used to produce electricity in the United States in 2021, the distribution of sources is quite different; petroleum and natural gas account for less than $40\%$ of the energy consumed to produce electricity (see Figure \ref{US_electricity_2021}).\footnote{US Energy Information Administration, FAQ: What is US electricity generation by source? \url{www.eia.gov/tools/faqs/faq.cfm?id=427\&t=3}} The mixture of the sources of energy used to generate the electricity you use will vary depending on where you live.

\begin{figure}
{\par\centering \includegraphics{US_electricity_2021.png} \par}
\caption{United States sources for electricity production, 2021} \label{US_electricity_2021}
\end{figure}
...
\item Utility clamp
\item Tape
\item 25 W, 60 W, and 100 W (or equivalent) bulbs 
...
\begin{enumerate}
	...
	\begin{center}	\includegraphics[width=0.40\textwidth]{renewable_important_setup.png}
	\end{center}
	\item Clamp a lamp fitted with a 25 W (or equivalent) bulb to one ring stand using a utility clamp.
	\item Place the lamp and ring stand into a large box.
	\item Securely tape the light sensor to the opposite inside corner of the box, so that ambient sensor is facing the bulb.
	...
	\item Once the bulb is cool to the touch, replace it with the 60 W (or equivalent) bulb. Repeat Steps 3--6.

	\item When the bulb is cool to the touch, replace it with the 100 W (or equivalent) bulb. Repeat Steps 3--6.
\end{enumerate}
...
\begin{tabular}{ | M{1.8cm} | M{1.6cm} | M{3.2cm} | M{2.6cm} | M{3.8cm} | }  
 ...
 \centering{Natural gas} & 25 & & 1.22 & \\[15pt] \hline
 Natural gas & 60 & & 1.22  & \\[15pt] \hline
 Natural gas & 100 & & 1.22  & \\[15pt] \hline
 Coal & 25 & & 2.08 & \\[15pt] \hline
 Coal & 60 & & 2.08  & \\[15pt] \hline
 Coal & 100 & & 2.08  & \\[15pt] \hline
 Wind & & & 0.03 & \\[15pt] \hline
 Solar & & &  0.15 & \\[15pt] \hline
\end{tabular}
\end{table}
